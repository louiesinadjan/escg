...
struct Params {
    ...
    bool maxStep = true; // Process numRandoms number of MCS per metal call
...
struct MetalContext {
    ...
    MTL::Library* library;
    MTL::ComputePipelineState* pipelineStateInvasions;    // Random action PSO
    ...
    MTL::Buffer* resultBufferInvasions;
    ...
    MTL::Buffer* neighboursDirsBuffer;            // Neighbour directions to proces
    MTL::Buffer* invasionProbabilitiesBuffer;     // Invasion?
